...
export default function SubHeader() {
  ...
  useClickOutside(filterModalRef, () => {
    setData({ ...data, isFilterModalOpen: false });
  });
    ...
    <>
      <header className={styles.header}>
        ...
        <div className={styles.column2}>
          ...
          <div className={styles.svg_container} onClick={() => toggleModal("isViewsModalOpen")}>
          ...
          <div ref={filterModalRef} className={styles.svg_container} onClick={() => toggleModal("isFilterModalOpen")}>
          ...
          <div className={styles.svg_container} onClick={() => toggleModal("isSortByModalOpen")}>
